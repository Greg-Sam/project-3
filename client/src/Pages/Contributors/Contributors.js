      ...
      <MDBRow>
        <MDBCol md="2">
         ...
         <hr></hr>
          <h4>Amee Parmar</h4>
          <hr></hr>
            <a href="mailto:amee05@yahoo.com">
              <img src="https://img.icons8.com/dusk/40/000000/email.png" alt="Email" />
            </a>
            <a href="https://github.com/amee05">

              <img src="https://img.icons8.com/plasticine/50/000000/github.png" alt="GitHub" />
            </a>
          
            <a href="https://www.linkedin.com/in/amee-parmar-5b30a526/?trk=profile-badge-cta">
        ...
        <MDBCol md="2">
          ...
          {/* <a href="https://github.com/Greg-Sam"><MDBIcon fab icon="github" size="2x" /></a> */}
            <a href="mailto:grssam@gmail.com">
              <img src="https://img.icons8.com/dusk/40/000000/email.png" alt="Email" />
            </a>
            <a href="https://github.com/Greg-Sam">

              <img src="https://img.icons8.com/plasticine/65/000000/github.png" alt="GitHub" />
              
            </a>
            <a href="https://www.linkedin.com/in/greg-samuelson/"> 
        ...
        <MDBCol md="2">
          ...
          {/* <a href="https://github.com/ky-lore"><MDBIcon fab icon="github" size="2x" /></a> */}
            <a href="mailto:kclore3131@gmail.com">
              <img src="https://img.icons8.com/dusk/40/000000/email.png" alt="Email" />
            </a>
            <a href="https://github.com/ky-lore">
        ...
        <MDBCol md="2">
          ...
          {/* <a href="https://github.com/Josclud"><MDBIcon fab icon="github" size="2x" /></a> */}
            <a href="mailto:josclud@gmail.com">
              <img src="https://img.icons8.com/dusk/40/000000/email.png" alt="Email" />
            </a>
            <a href="https://github.com/Josclud">

              <img src="https://img.icons8.com/plasticine/65/000000/github.png" alt="GitHub" />
            </a>
            <a href="https://www.linkedin.com/in/joseph-wong-ludwicak/">
        ...
        <img src="https://media.discordapp.net/attachments/783457733164400710/787078521570852884/project22222.jpg?width=350&height=350"
          ...
          {/* <a href="https://github.com/wlinton1"><MDBIcon fab icon="github" size="2x" /></a> */}
            <a href="mailto:wettimlinton123@gmail.com">
              <img src="https://img.icons8.com/dusk/40/000000/email.png" alt="Email" />
            </a>
            <a href="https://github.com/wlinton1">

              <img src="https://img.icons8.com/plasticine/65/000000/github.png" alt="GitHub" />
            </a>
            <a href="https://www.linkedin.com/in/wettim-linton-54b4421a6/"> 
